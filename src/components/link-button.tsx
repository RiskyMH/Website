...
export default function LinkButton({ url = "", text, Icon, newTab = false, noMobile = false, disabled = false, small = false, primary = false }: LinkButtonProps) {
  return (
    <a
      href={url === "" ? "#" : url}
      ...
      className={
        ...
        (primary
          ? (small ? "px-3 py-1 text-xs min-w-[3.5rem]" : "p-1.5 text-sm min-w-[5.25rem]")
        ...
        // Minimal, slightly lighter focus ring
